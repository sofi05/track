window.CHARA_CONFIG = {
  characters: [
    ...
    { name: 'Jane Doe', imgName: '24', have: false, element: 'IconPhysical', group:'spec', gender:'f', rarity: 5, status: 'available', version: '2.5', want: 1, p:1 },
    { name: 'Caesar', imgName: '25', have: false, element: 'IconPhysical', group:'sons', gender:'f', rarity: 5, status: 'available', version: '2.0', want: 2 },
    { name: 'Lighter', imgName: '26', have: false, element: 'IconFire', group:'sons', gender:'m', rarity: 5, status: 'available', version: '1.7', want: 2 },
    { name: 'Qingyi', imgName: '29', have: false, element: 'IconElectric', group:'spec', gender:'f', rarity: 5, status: 'available', version: '2.5', want: 1, p:1 },
    { name: 'Yanagi', imgName: '31', have: false, element: 'IconElectric', group:'sec6', gender:'f', rarity: 5, status: 'available', version: '2.1' },
    { name: 'Burnice', imgName: '32', have: false, element: 'IconFire', group:'sons', gender:'f', rarity: 5, status: 'available', version: '2.5', want: 2, p:1 },
    { name: 'Astra Yao', imgName: '36', have: false, element: 'IconEther', group:'star', gender:'f', rarity: 5, status: 'available', version: '2.5', p:2 },
    { name: 'Evelyn', imgName: '37', have: false, element: 'IconFire', group:'star', gender:'f', rarity: 5, status: 'available', version: '2.2', p:2 },
    { name: 'Trigger', imgName: '39', have: false, element: 'IconElectric', group:'obol', gender:'f', rarity: 5, status: 'available', version: '2.2', p:1, want: 2 },
    ...
    { name: 'Yixuan', imgName: '44', have: false, element: 'IconAuricInk', filterElement: 'IconEther', group:'sum', gender:'f', rarity: 5, status: 'available', version: '2.6', want: 1,p:1 }, //last 2.0
    { name: 'Alice', imgName: '46', have: false, element: 'IconPhysical', group:'spook', gender:'f', rarity: 5, status: 'available', version: '2.5', p:2 },
    { name: 'Yuzuha', imgName: '47', have: false, element: 'IconPhysical', group:'spook', gender:'f', rarity: 5, status: 'available', version: '2.6', p:2 }, //last 2.1
