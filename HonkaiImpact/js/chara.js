const characters = [
  ...
  { name: 'Bronya • DB', imgName: 'Dimension_Breaker', folder:'Bronya', have: false, element: 'MECH', rarity: '5', part:'1', status: 'available' },
  { name: 'Bronya • DK', imgName: 'Drive_Kometa', folder:'Bronya', have: false, element: 'PSY', rarity: '4', part:'1', status: 'available' },
  ...
  { name: 'Bronya • S', imgName: 'Silverwing_-_N-EX', folder:'Bronya', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Durandal • BN', imgName: 'Bright_Knight_-_Excelsis', folder:'Durandal', have: false, element: 'MECH', rarity: '5', part:'1', status: 'available' },
  { name: 'Durandal • DA', imgName: 'Dea_Anchora', folder:'Durandal', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  { name: 'Durandal • PE', imgName: 'Palatinus_Equinox', folder:'Durandal', have: false, element: 'IMG', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Elysia • MPE', imgName: 'Miss_Pink_Elf', folder:'Elysia', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },

  { name: 'Fu Hua • AE', imgName: 'Azure_Empyrea', folder:'FuHua', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Fu Hua • FoV', imgName: 'Fenghuang_of_Vicissitude', folder:'FuHua', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  { name: 'Fu Hua • HoF', imgName: 'Hawk_of_the_Fog', folder:'FuHua', have: false, element: 'PSY', rarity: '4', part:'1', status: 'available' },
  ...
  { name: 'Fu Hua • P', imgName: 'Phoenix', folder:'FuHua', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Fu Hua • SK', imgName: 'Shadow_Knight', folder:'FuHua', have: false, element: 'MECH', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Himeko • BR', imgName: 'Blood_Rose', folder:'Himeko', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Kiana • HoF', imgName: 'Herrscher_of_Flamescion', folder:'Kiana', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Kiana • HoV', imgName: 'Herrscher_of_the_Void', folder:'Kiana', have: true, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  { name: 'Kiana • KM', imgName: 'Knight_Moonbeam', folder:'Kiana', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  { name: 'Kiana • VR', imgName: 'Valkyrie_Ranger', folder:'Kiana', have: false, element: 'MECH', rarity: '4', part:'1', status: 'available' },
  { name: 'Kiana • VD', imgName: 'Void_Drifter', folder:'Kiana', have: false, element: 'MECH', rarity: '4', part:'1', status: 'available' },
  ...
  { name: 'Mei • DS', imgName: 'Danzai_Spectramancer', folder:'Mei', have: false, element: 'MECH', rarity: '4', part:'1', status: 'available' },
  { name: 'Mei • HoO', imgName: 'Herrscher_of_Origin', folder:'Mei', have: true, element: 'IMG', rarity: '5', part:'1', status: 'available' },
  { name: 'Mei • HoT', imgName: 'Herrscher_of_Thunder', folder:'Mei', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Mei • LE', imgName: 'Lightning_Empress', folder:'Mei', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Mei • SD', imgName: 'Shadow_Dash', folder:'Mei', have: true, element: 'MECH', rarity: '4', part:'1', status: 'available' },
  { name: 'Mei • SF', imgName: 'Striker_Fulminata', folder:'Mei', have: false, element: 'BIO', rarity: '4', part:'1', status: 'available' },
  ...
  { name: 'Rozalia • FT', imgName: 'Fervent_Tempo', folder:'Olenyeva', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Rozalia • MC', imgName: 'Molotov_Cherry', folder:'Olenyeva', have: true, element: 'PSY', rarity: '5', part:'1', status: 'available' },

  { name: 'Rita • AK', imgName: 'Argent_Knight_-_Artemis', folder:'Rita', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' }, 
  ...
  { name: 'Rita • SA', imgName: 'Spina_Astera', folder:'Rita', have: false, element: 'MECH', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Seele • HoR', imgName: 'Herrscher_of_Rebirth', folder:'Seele', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  { name: 'Seele • SN', imgName: 'Starchasm_Nyx', folder:'Seele', have: false, element: 'QUA', rarity: '5', part:'1', status: 'available' },
  { name: 'Seele • SN', imgName: 'Stygian_Nymph', folder:'Seele', have: false, element: 'QUA', rarity: '5', part:'1', status: 'available' },
  { name: 'Seele • SP', imgName: 'Swallowtail_Phantasm', folder:'Seele', have: true, element: 'QUA', rarity: '4', part:'1', status: 'available' },

  { name: 'Sushang', imgName: 'Jade_Knight', folder:'Sushang', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  
  { name: 'Theresa • CH', imgName: 'Celestial_Hymn', folder:'Theresa', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  { name: 'Theresa • LK', imgName: 'Luna_Kindred', folder:'Theresa', have: true, element: 'BIO', rarity: '4', part:'1', status: 'available' },
  { name: 'Theresa • LV', imgName: 'Lunar_Vow_-_Crimson_Love', folder:'Theresa', have: false, element: 'PSY', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Theresa • TP', imgName: 'Twilight_Paladin', folder:'Theresa', have: false, element: 'MECH', rarity: '5', part:'1', status: 'available' },
  { name: 'Theresa • VP', imgName: 'Valkyrie_Pledge', folder:'Theresa', have: true, element: 'PSY', rarity: '4', part:'1', status: 'available' },
  { name: 'Theresa • VE', imgName: 'Violet_Executer', folder:'Theresa', have: false, element: 'MECH', rarity: '5', part:'1', status: 'available' },

  { name: 'Ai Hyperion', imgName: 'Chrono_Navi', folder:'SoloChara', have: true, element: 'MECH', rarity: '4', part:'1', status: 'available' }, 
  { name: 'Aponia', imgName: 'Disciplinary_Perdition', folder:'SoloChara', have: false, element: 'BIO', rarity: '5', part:'1', status: 'available' },
  ...
  { name: 'Vill-V', imgName: 'Helical_Contraption', folder:'SoloChara', have: false, element: 'QUA', rarity: '5', part:'1', status: 'available' },
  { name: 'Mobius', imgName: 'Infinite_Ouroboros', folder:'SoloChara', have: false, element: 'MECH', rarity: '4', part:'1', status: 'available' },
  ...
  { name: 'Shigure Kira', imgName: 'Sugary_Starburst', folder:'SoloChara', have: false, element: 'MECH', rarity: '4', part:'1', status: 'available' },
  ...
  { name: 'Coralie • BF', imgName: 'Behold_Fate-Defying_Dragon', folder:'Coralie', have: false, element: 'MECH', rarity: '5', part:'2', status: 'new' },
  ...
  { name: 'Erdös • PA', imgName: 'Planar_Armament_-_Warped_Spacetime', folder:'Erdos', have: true, element: 'BIO', rarity: '5', part:'2', status: 'new' },
  ...
  { name: 'Sushang', imgName: 'Peregrine_Sword', folder:'Sushang', have: false, element: 'BIO', rarity: '5', part:'2', status: 'available' },
  { name: 'Senadina', imgName: 'Deepspace_Anchor_-_First_Light', folder:'SoloChara', have: false, element: 'SD', rarity: '5', part:'2',  status: 'available' },
  { name: 'Songque', imgName: 'Jovial_Deception_-_Shadowdimmer', folder:'SoloChara', have: false, element: 'SD', rarity: '5', part:'2',  status: 'available' },
  { name: '"Lantern"', imgName: 'Lone_Destruction_-_Shadowchaser', folder:'SoloChara', have: false, element: 'PSY', rarity: '5', part:'2',  status: 'available' },
  { name: 'Thelema', imgName: 'Mad_Pleasure_-_Shadowbringer', folder:'SoloChara', have: false, element: 'MECH', rarity: '5', part:'2',  status: 'available' },
  { name: 'Vita', imgName: 'Lone_Planetfarer', folder:'SoloChara', have: false, element: 'MECH', rarity: '5', part:'2',  status: 'available' },
  { name: 'Theresa', imgName: 'Schicksals_Imperative', folder:'Theresa', have: false, element: 'QUA', rarity: '5', part:'2',  status: 'available', version:'2.8' },
