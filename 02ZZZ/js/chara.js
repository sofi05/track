window.CHARA_CONFIG = {
  characters: [
    ...
    //DONT HAVE
    { name: 'Nekomata', imgName: '11', have: false, element: 'IconPhysical', group:'cunhar', gender:'f', rarity: 5, status: 'available', version: '2.0', perma: true, want: true },
    ...
    { name: 'Jane Doe', imgName: '24', have: false, element: 'IconPhysical', group:'spec', gender:'f', rarity: 5, status: 'available', version: '1.7', want: true },
    { name: 'Caesar', imgName: '25', have: false, element: 'IconPhysical', group:'sons', gender:'f', rarity: 5, status: 'available', version: '2.0' },
    { name: 'Lighter', imgName: '26', have: false, element: 'IconFire', group:'sons', gender:'m', rarity: 5, status: 'available', version: '1.7', want: true },
    { name: 'Qingyi', imgName: '29', have: false, element: 'IconElectric', group:'spec', gender:'f', rarity: 5, status: 'available', version: '1.5', want: true },
    { name: 'Yanagi', imgName: '31', have: false, element: 'IconElectric', group:'sec6', gender:'f', rarity: 5, status: 'available', version: '2.1' },
    { name: 'Burnice', imgName: '32', have: false, element: 'IconFire', group:'sons', gender:'f', rarity: 5, status: 'available', version: '1.6', want: true },
    ...
    { name: 'Trigger', imgName: '39', have: false, element: 'IconElectric', group:'obol', gender:'f', rarity: 5, status: 'available', version: '2.2', p:1, want: true },
    { name: 'Vivian', imgName: '41', have: false, element: 'IconEther', group:'mock', gender:'f', rarity: 5, status: 'available', version: '2.3', p:1 },
    { name: 'Hugo', imgName: '42', have: false, element: 'IconIce', group:'mock', gender:'m', rarity: 5, status: 'available', version: '2.4', p:1 },
    { name: 'Ju Fufu', imgName: '43', have: false, element: 'IconFire', group:'sum', gender:'f', rarity: 5, status: 'available', version: '2.3', p:2 },
    { name: 'Yixuan', imgName: '44', have: false, element: 'IconAuricInk', filterElement: 'IconEther', group:'sum', gender:'f', rarity: 5, status: 'available', version: '2.0', want: true },
    ...
    { name: 'Seed', imgName: '48', have: false, element: 'IconElectric', group:'obol', gender:'f', rarity: 5, status: 'available', version: '2.2', p:1, want: true },
    ...
    { name: 'Shunguan', imgName: '55', have: false, element: 'IconHonedEdge', filterElement: 'IconPhysical', group:'', gender:'f', rarity: 5, status: 'soon', version: '2.5', p:2, want: true},
