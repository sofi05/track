const gameConfig = {
  characters: [
    ...
    { name: 'Durin', imgName: 'UI_AvatarIcon_DurinCostumeWic',imgName2:'DurinCostumeWic', have: false, rarity: 4, status: 'available' },
    
    { name: 'Neuvillette', imgName: '',imgName2:'NeuvilletteCostumeWinter', have: false, rarity: 4, status: 'new' },
    { name: 'Yaoyao', imgName: 'YaoyaoCostumeWinter',imgName2:'', have: false, rarity: 4, status: 'new' },
