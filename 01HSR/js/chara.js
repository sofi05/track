window.CHARA_CONFIG = {
  characters: [
    ...
    { name: 'Topaz & Numby', imgName: '1112', have: true, element: 'fire', group:'hunt', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
    ...
    { name: 'Dan Heng • IL', imgName: '1213', have: true, element: 'imaginary', group:'dest', gender:'m', world:['ae'],rarity: 5,  status: 'available' },
    ...
    { name: 'March 7th ', imgName: '1224', have: true, element: 'imaginary', group:'hunt', gender:'f', world:['ae'],rarity: 4, status: 'available'},
    ...
    //DONT HAVE
    { name: 'Welt', imgName: '1004', have: false, element: 'imaginary', group:'nihi', gender:'m', world:['ae'],rarity: 5,  status: 'available', version: '3.2', perma: true, want: true },
    ...
    { name: 'Yunli', imgName: '1221', have: false, element: 'physical', group:'dest', gender:'f', world:['txl'], rarity: 5,  status: 'available', version: '3.1', want: true },
    { name: 'Lingsha', imgName: '1222', have: false, element: 'fire', group:'abun', gender:'f', world:['txl'], rarity: 5,  status: 'available', version: '3.0', want: true },
    { name: 'Fugue', imgName: '1225', have: false, element: 'fire', group:'nihi', gender:'f', world:['txl'], rarity: 5,  status: 'available', version: '3.2' },

    { name: 'Ruan Mei', imgName: '1303', have: false, element: 'ice', group:'harm', gender:'f', world:['hss'],rarity: 5,  status: 'available', version: '3.7', perma: true },
    { name: 'Sparkle', imgName: '1306', have: false, element: 'quantum', group:'harm', gender:'f', world:['ot'],rarity: 5,  status: 'available', version: '3.4', want: true },
    ...
    { name: 'Sunday', imgName: '1313', have: false, element: 'imaginary', group:'harm', gender:'m', world:['ae','pena'], rarity: 5,  status: 'available', version: '3.4', want: true },
    ...
    { name: 'Mydei', imgName: '1404', have: false, element: 'imaginary', group:'dest', gender:'m', world:['amp'], rarity: 5,  status: 'available', version: '3.7', p:2, want: true },
    ...
    { name: 'Cyrene', imgName: '1415', have: false, element: 'ice', group:'reme', gender:'f', world:['amp'],rarity: 5,  status: 'new', version: '3.7' },
