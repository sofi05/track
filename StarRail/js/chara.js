...
{ name: 'Phainon', imgName: '1408', have: true, element: 'physical', group:'dest', gender:'f', world:['amp'], rarity: 5,  status: 'available' },
...
{ name: 'Anaxa', imgName: '1405', have: false, element: 'wind', group:'eru', gender:'f', world:['amp'], rarity: 5,  status: 'available', version: '3.2' },
{ name: 'Castorice', imgName: '1407', have: true, element: 'quantum', group:'reme', gender:'f', world:['amp'], rarity: 5,  status: 'available' },
{ name: 'Mydei', imgName: '1404', have: false, element: 'imaginary', group:'dest', gender:'f', world:['amp'], rarity: 5,  status: 'available', version: '3.1' },
...
{ name: 'Sunday', imgName: '1313', have: false, element: 'imaginary', group:'harm', gender:'f', world:['ae','pena'], rarity: 5,  status: 'available', version: '3.4' },
...
{ name: 'Moze', imgName: '1223', have: true, element: 'thunder', group:'hunt', gender:'f', world:['txl'], rarity: 4,  status: 'available' },
{ name: 'Jiaoqiu', imgName: '1218', have: false, element: 'fire', group:'nihi', gender:'f', world:['txl'], rarity: 5,  status: 'available', version: '3.2' },
...
{ name: 'Boothill', imgName: '1315', have: false, element: 'physical', group:'hunt', gender:'f', world:['ot'],rarity: 5,  status: 'available', version: '3.0' },
{ name: 'Robin', imgName: '1309', have: false, element: 'physical', group:'harm', gender:'f', world:['pena'],rarity: 5,  status: 'available', version: '3.0' },
{ name: 'Aventurine', imgName: '1304', have: true, element: 'imaginary', group:'prese', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
{ name: 'Gallagher', imgName: '1301', have: true, element: 'fire', group:'abun', gender:'f', world:['pena'],rarity: 4,  status: 'available' },
{ name: 'Acheron', imgName: '1308', have: true, element: 'thunder', group:'nihi', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
{ name: 'Misha', imgName: '1312', have: true, element: 'ice', group:'dest', gender:'f', world:['pena'],rarity: 4,  status: 'available' },
...
{ name: 'Dr. Ratio', imgName: '1305', have: true, element: 'imaginary', group:'hunt', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
...
{ name: 'Argenti', imgName: '1302', have: true, element: 'physical', group:'eru', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
...
{ name: 'Dan Heng • IL', imgName: '1213', have: true, element: 'imaginary', group:'dest', gender:'f', world:['ae','txl'],rarity: 5,  status: 'available' },
{ name: 'Kafka', imgName: '1005', have: true, element: 'thunder', group:'nihi', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
{ name: 'Luka', imgName: '1111', have: true, element: 'physical', group:'nihi', gender:'f', world:['JVI'],rarity: 4,  status: 'available' },
{ name: 'Blade', imgName: '1205', have: true, element: 'wind', group:'dest', gender:'f', world:['txl'],rarity: 5,  status: 'available' },
{ name: 'Luocha', imgName: '1203', have: true, element: 'imaginary', group:'abun', gender:'f', world:['ot'],rarity: 5,  status: 'available' },
...
{ name: 'Jing Yuan', imgName: '1204', have: false, element: 'thunder', group:'eru', gender:'f', world:['txl'], rarity: 5,  status: 'available', version: '2.7' },
{ name: 'March 7th', imgName: '1001', have: true, element: 'ice', group:'prese', gender:'f', world:['ae'],rarity: 4,  status: 'available' },
{ name: 'Dan Heng', imgName: '1002', have: true, element: 'wind', group:'hunt', gender:'f', world:['ae'],rarity: 4,  status: 'available' },
{ name: 'Himeko', imgName: '1003', have: true, element: 'fire', group:'eru', gender:'f', world:['ae'],rarity: 5,  status: 'available' },
{ name: 'Welt', imgName: '1004', have: false, element: 'imaginary', group:'nihi', gender:'f', world:['ae'],rarity: 5,  status: 'available', version: '3.2' },
{ name: 'Arlan', imgName: '1008', have: true, element: 'thunder', group:'dest', gender:'f', world:['hss'], rarity: 4,  status: 'available' },
...
{ name: 'Gepard', imgName: '1104', have: true, element: 'ice', group:'prese', gender:'f', world:['JVI'],rarity: 5,  status: 'available' },
...
{ name: 'Sampo', imgName: '1108', have: true, element: 'wind', group:'nihi', gender:'f', world:['JVI'],rarity: 4,  status: 'available' },
...
{ name: 'Yanqing', imgName: '1209', have: true, element: 'ice', group:'hunt', gender:'f', world:['txl'], rarity: 5,  status: 'available' },
...
{ name: 'Dan Heng • PT', imgName: '1414', have: false, element: 'thunder', group:'prese', gender:'f', world:['ae','amp'],rarity: 5,  status: 'soon', version: '3.6' },
