document.addEventListener('DOMContentLoaded', () => {
  ...
  const characters = [
    ...
    { name: 'Cryboo', have: false, rarity: '4' },
    { name: 'Avocaboo', have: false, rarity: '4' },
    { name: 'Paperboo', have: false, rarity: '4' },
    { name: 'Sumoboo', have: false, rarity: '4' },
    { name: 'Exploreboo', have: false, rarity: '4' },
    { name: 'Sharkboo', have: false, rarity: '5' },
    { name: 'Butler', have: false, rarity: '5' },
    { name: 'Safety', have: false, rarity: '5' },
    { name: 'Luckyboo', have: false, rarity: '4' },
    { name: 'Penguinboo', have: false, rarity: '4' },
    { name: 'Amillion', have: false, rarity: '5' },
    { name: 'Devilboo', have: false, rarity: '4' },
    { name: 'Rocketboo', have: false, rarity: '5' },
    { name: 'Electroboo', have: false, rarity: '4' },
    { name: 'Booressure', have: false, rarity: '4' },
    { name: 'Boollseye', have: false, rarity: '4' },
    { name: 'Plugboo', have: false, rarity: '5' },
    { name: 'Resonaboo', have: false, rarity: '5' },
    { name: 'Magnetiboo', have: false, rarity: '4' },
    { name: 'Bangvolver', have: false, rarity: '5' },
    { name: 'Baddieboo', have: false, rarity: '4' },
    { name: 'Officer Cui', have: false, rarity: '5' },
    { name: 'Red Moccus', have: false, rarity: '5' },
    { name: 'Knightboo', have: false, rarity: '4' },
    { name: 'Agent Gulliver', have: false, rarity: '5' },
