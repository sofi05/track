window.CHARA_CONFIG = {
  characters: [
    ...
    { name: 'Baizhu', imgName: 'Baizhuer', have: false, element: 'Dendro', rarity: 5, region:['liy'], gender:'m',  status: 'available', version: '5.3', want: true },
    ...
    { name: 'Dahlia', have: false, element: 'Hydro', rarity: 4, region:['mond'], gender:'m',  status: 'available', version: '5.7', perma: true, want: true },
    ...
    { name: 'Mavuika', have: false, element: 'Pyro', rarity: 5, region:['nat'], gender:'f',  status: 'available', version: '5.7', want: true },
    { name: 'Varesa', have: false, element: 'Electro', rarity: 5, region:['nat'], gender:'f',  status: 'available', version: '6.2', p:2, want: true },
    { name: 'Emilie', have: false, element: 'Dendro', rarity: 5, region:['font'], gender:'f',  status: 'available', version: '5.7', want: true },
    ...
    { name: 'Ineffa', have: false, element: 'Electro', rarity: 5, region:['nat','snez'], gender:'f',  status: 'available', version: '5.8' },
    { name: 'Shenhe', have: false, element: 'Cryo', rarity: 5, region:['liy'], gender:'f',  status: 'available', version: '5.7' },
    { name: 'Wriothesley', have: false, element: 'Cryo', rarity: 5, region:['font'], gender:'m',  status: 'available', version: '5.4', want: true},
    ...
    { name: 'Jahoda', have: false, element: 'Anemo', rarity: 4, region:['snez'], gender:'f',  status: 'soon', version: '6.2', want: true },
    { name: 'Durin', have: false, element: 'Pyro', rarity: 5, region:['mond'], gender:'m',  status: 'soon', version: '6.2', want: true },
