const gameConfig = {
  ...
  characters: [
    ...
    { name: 'Durandal', imgName: 'Bright_Knight_-_Excelsis', folder: 'Durandal', spriteFolder: 'Durandal', have: false, part: '1',
        spriteImages: ['Emerald_of_Alfheim', 'Starlit_Evening', 'Purrfect_Holiday', 'Misty_Lavender', 'Lord_Paramount', 
        'Gale_Hunter', 'Heavenward_Dragon', 'Pumping_Heart', 'Red_Dragon_Rises', 'Stellar_Promise', 'Nibelungen_Traumlied'], },
    ...
    { name: 'Himeko', imgName: 'Battle_Storm', folder: 'Himeko', spriteFolder: 'Himeko', have: false, part: '1',
        ...
        'Summer_Party', 'Red_Mist', 'Origin', 'Night_Enchantress', 'Holy_Rose', 'Black_Mamba'], },
    ...
    { name: 'Kiana', imgName: 'White_Comet', folder: 'Kiana', spriteFolder: 'Kiana', have: false, part: '1', 
        ...
        'Radiant_Blaze','Red_Lictor', 'Selenic_Ripples','Wintery_Wishes_Figure'], },
    ...
    { name: 'Mei', imgName: 'Crimson_Impulse', folder: 'Mei', spriteFolder: 'Mei', have: false, part: '1',
        spriteImages: ['Aeterna_Purum', 'Blue_Memories', 'Hind_of_Noel', 'Soul_Symphony','Vast_Ocean', 'Aqua_Chime',
        'Eventide_Phantom','Gardenia','Scorching_Golden_Thunder','Ultramarine_Octave', 'Aqueous_Springtide',
        'Haunted_Dusk','Nocturne_Ablaze','Rainy_Springtide', 'Orochi_Cuirass','Thunderbolt_Drive', 'Crooning_Tides'], },
    ...
    { name: 'Rozalia', imgName: 'Fervent_Tempo', folder:'Olenyeva', spriteFolder: 'Olenyeva', have: false, part: '1',
        spriteImages: ['Violet_Dreamscape', 'Gothic_Rozamary', 'Coral_Sunrise', '8-bit_Fever'], },
    ...
    { name: 'Seele', imgName: 'Stygian_Nymph', folder: 'Seele', spriteFolder: 'Seele', have: false, part: '1',
        spriteImages: ['Azure_Memories', 'Dream_Seeker', 'Papilio_Lily', 'Estonia_in_Spring', 'Mirrored_Flourishes',
        'Stygian_Seafoam', 'Eternal_Nights_Embrace', 'Magic_Girl_Seele','On_Fair_Clouds'], },
    ...
    { name: 'Theresa', imgName: 'Valkyrie_Pledge', folder: 'Theresa', spriteFolder: 'Theresa', have: false, part: '1',
        ...
        'Heat_of_Trifolium','Lilac_of_the_Valley', 'Magic_Girl_Teriri','Morning_Sunshine','Ouranons_Forgiveness','Pledge',
        'Rosy_Bridesmaid','Shallow_Sunset','Starry_Night','Sugar_Haw_Child','Wonderland_Trek', 'Herald_of_Spring',
        'Orchids_Night','Startold_Fortune', 'Redolent_in_Red','Till_Death_Do_Us_Part', 'Verdant_Sky'], },
